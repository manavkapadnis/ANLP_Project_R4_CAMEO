...
preds_file = json.load(open("/home/mkapadni/work/anlp_project/src/save/vizwiz/v1_delta_new_prompt/result/result_0_889.json"))
...
df_preds.to_csv("/home/mkapadni/work/anlp_project/src/preds_organized/caption_skill_vqa.csv", index=False)
