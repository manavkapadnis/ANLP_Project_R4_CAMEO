#!/bin/bash
#SBATCH --job-name=delta_run_3_epochs_only_skill_and_vqa
#SBATCH --output=delta_run_3_epochs_only_skill_and_vqa.out
#SBATCH --error=delta_run_3_epochs_only_skill_and_vqa.err
...
version="v1_delta_new_prompt_only_skill_and_vqa"
...
python -u creating_mtl_baseline_with_only_skill_and_vqa.py \
    --dataset ${dataset} \
