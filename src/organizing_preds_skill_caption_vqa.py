...
preds_file = json.load(open("/home/mkapadni/work/anlp_project/src/save/vizwiz/v1_delta_new_prompt_skill_before_caption/result/result_2_2669.json"))
...
df_preds.to_csv("/home/mkapadni/work/anlp_project/src/preds_organized/skills_caption_vqa.csv", index=False)
