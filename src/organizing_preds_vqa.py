...
preds_file = json.load(open("/home/mkapadni/work/anlp_project/src/save/vizwiz/v1_delta_new_prompt_only_vqa/result/result_1_1779.json"))
...
df_preds.to_csv("/home/mkapadni/work/anlp_project/src/preds_organized/vqa_only.csv", index=False)
