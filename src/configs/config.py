...
parser = argparse.ArgumentParser(description="hyper-parameter for MultitaskVQA")
# ========================= Dataset Configs ==========================
...
parser.add_argument('--dataset', type=str, default='vizwiz', help="iu-xray or mimic-cxr")
parser.add_argument('--annotation', type=str, default=r'./data/mimic_cxr/annotation.json', help="annotation file of the dataset")
parser.add_argument('--image_dir', type=str, default=r'/home/mkapadni/work/anlp_project/data/images', help="base dir to help find images")
...
# parser.add_argument('--train_csv', default=df_train, type=int, help="Cpu num for dataloaders")
# parser.add_argument('--val_csv', default=df_val, type=int, help="Cpu num for dataloaders")

# ========================= Model Settings ============================microsoft/swin-base-patch4-window7-224
# parser.add_argument('--vision_model', default='facebook/dinov2-base', type=str, help="vision model to use")
parser.add_argument('--vision_model', default='microsoft/swin-base-patch4-window7-224', type=str, help="vision model to use")
parser.add_argument('--llama_model', default='Qwen/Qwen2.5-7B-Instruct', type=str, help="LLM model to use")
# parser.add_argument('--llama_model', default='Qwen/Qwen2.5-3B-Instruct', type=str, help="LLM model to use")
...
# ======================== SavedModel Configs ===========================
parser.add_argument('--savedmodel_path', type=str, default='save/vizwiz/v1')
...
parser.add_argument('--max_epochs', type=int, default=2, help='Stop training once this number of epochs is reached')
